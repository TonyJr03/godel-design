...
export function TaskTemplateCreateDialogButton() {
  ...
  return (
    <>
      ...
      <InternalFormDialog
        isOpen={isOpen}
        title="Nueva plantilla"
        description="Crea una plantilla reutilizable para tareas de producción."
        onClose={closeDialog}
        ...
        {isOpen ? (
          <TaskTemplateForm
            ...
            onSuccess={() => {
              setHasUnsavedChanges(false);
              setIsOpen(false);
              window.location.assign("/dashboard/configuracion/plantillas");
            }}
          />
        ) : null}
      </InternalFormDialog>
