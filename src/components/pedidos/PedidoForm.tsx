...
export function PedidoForm({
  ...
  const renderWorkflowButtons = (variant: "compact" | "normal") =>
  ...
  const compactBlockClassName = "space-y-3";
  const compactSeparatedBlockClassName =
    "space-y-3 border-t border-border pt-5";
  const compactHeadingClassName = "text-base font-semibold text-text-primary";
      ...
      >
        <FormSection compact>
          <div className="space-y-5">
            ...
            <div className={compactBlockClassName}>
              <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                <span className={compactHeadingClassName}>
                  Tipo de pedido
            ...
            <div
              ...
              className={compactSeparatedBlockClassName}
            >
              <h3 className={compactHeadingClassName}>
            ...
            <div className={compactSeparatedBlockClassName}>
              <h3 className={compactHeadingClassName}>Datos del pedido</h3>
