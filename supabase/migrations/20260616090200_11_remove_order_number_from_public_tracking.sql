drop function if exists public.consultar_estado_publico(text);
...
comment on function public.consultar_estado_publico(text) is
  'Consulta publica controlada por public_reference. Devuelve solo estado y fechas no sensibles, sin numero operativo interno.';
