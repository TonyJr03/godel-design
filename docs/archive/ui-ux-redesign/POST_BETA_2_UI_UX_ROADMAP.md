...
* Bloqueantes: ninguno.
* Mayores: ninguno.
* Menores corregidos: se agregó una captura exacta `1024x768` al Full Visual QA.
* Menores corregidos: eliminación de controles duplicados e IDs repetidos en
...
* Permanece la deuda existente de dividir el Full Visual QA en specs más pequeños
...
No existe próxima etapa activa para este roadmap.
