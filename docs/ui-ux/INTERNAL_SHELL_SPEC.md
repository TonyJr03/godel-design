...
- Cierre histórico documentado en
  `../archive/ui-ux-redesign/INTERNAL_SHELL_QA_REPORT.md`.
- La navegación móvil con `<details>` queda aceptada para esta etapa si la QA focal y Full Visual QA pasan.
