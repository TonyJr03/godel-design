...
- [SH-03 — Plan QA funcional production-like](SH_03_QA_PLAN.md): SH-03.0 cerrada/aprobada; SH-03.1 bloqueada por hallazgos funcionales de Server Actions.
- [SH-03.1 — Provisioning QA, Auth, session, roles y Auth Admin](SH_03_AUTH_QA_REPORT.md): evidencia self-hosted y hallazgos bloqueantes de finalización de Server Actions.
