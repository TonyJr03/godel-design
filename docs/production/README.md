...
- [SH-03 — Plan QA funcional production-like](SH_03_QA_PLAN.md): SH-03.0 cerrada/aprobada; SH-03.1 implementada y pendiente de revisión arquitectónica.
- [SH-03.1 — Provisioning QA, Auth, session, roles y Auth Admin](SH_03_AUTH_QA_REPORT.md): evidencia self-hosted y fallback documentado de compatibilidad para creates.
