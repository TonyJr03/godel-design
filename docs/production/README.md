...
- [SH-03 — Plan QA funcional production-like](SH_03_QA_PLAN.md): SH-03.0 y SH-03.1 cerradas/aprobadas; SH-03.2 está activa en inventario y baseline read-only.
...
- [SH-03.2A — Inventario core y baseline production-like](SH_03_CORE_QA_REPORT.md): inventario de acciones, baseline de solo lectura y gates B/C/D/E; pendiente de revisión arquitectónica.
