...
- [SH-03 — Plan QA funcional production-like](SH_03_QA_PLAN.md): SH-03.0, SH-03.1, SH-03.2A y SH-03.2B cerradas/aprobadas; SH-03.2C en progreso.
...
- [SH-03.2C — Solicitudes](SH_03_CORE_QA_REPORT.md): lifecycle por Nginx y fallback TD-NEXT-001 limitado por evidencia; implementada y pendiente de revisión arquitectónica.
