...
- [SH-05.1 — Contrato de portabilidad clean-host y diseño de tooling](SH_05_CLEAN_HOST_PORTABILITY_DESIGN.md): cerrado y aprobado; define el contrato fail-closed para SH-05.2/SH-05.3 sin ejecutar portabilidad, mutar runtime ni desplegar. SH-05.2 está activo; SH-05.2A está cerrado/aprobado y SH-05.2B implementa sólo el lock de autoridad de imágenes pull-only, pendiente de revisión arquitectónica. La adquisición clean-host sigue sin implementar.
