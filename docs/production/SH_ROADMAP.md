...
SH-04.4C.1 está `CLOSED / APPROVED / PASS_TOOLING`, SH-04.4C.2 está `BLOCKED_PREREQUISITES` y SH-04.5 no ha iniciado.
...
| SH-04.4C | IN PROGRESS (C.0 CLOSED / BLOCKED_ACTIONABLE; C.1 CLOSED / APPROVED / PASS_TOOLING; C.2 BLOCKED_PREREQUISITES) |
| SH-04.5 | NOT STARTED |
...
handoff actual es SH-04.4A `CLOSED / APPROVED` → SH-04.4B `CLOSED / APPROVED` → SH-04.4C.1 `CLOSED / APPROVED / PASS_TOOLING` → SH-04.4C.2 `BLOCKED_PREREQUISITES`.
