...
PASS_IMMUTABLE_PULL_ONLY_IMAGE_ACQUISITION` y SH-05.2G queda `IMPLEMENTED /
...
| SH-05.2G — Verified Godel App / Nginx build | IMPLEMENTED / PENDING ARCHITECTURAL REVIEW |
...
`CLOSED / APPROVED / PASS_IMMUTABLE_PULL_ONLY_IMAGE_ACQUISITION` y SH-05.2G queda
