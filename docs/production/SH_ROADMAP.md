...
SH-04.4C.1 está `CLOSED / APPROVED / PASS_TOOLING`, su R3 está `CLOSED / APPROVED / PASS_JQ_PREFLIGHT_FIX`, SH-04.4C.2-P0 está `CLOSED / APPROVED / PASS_READINESS`, SH-04.4C.2 está `IN PROGRESS`, C.2-A está `IMPLEMENTED / PENDING ARCHITECTURAL REVIEW`, C.2-B `NOT AUTHORIZED` y SH-04.5 no ha iniciado.
...
| SH-04.4C | IN PROGRESS (C.0 CLOSED / BLOCKED_ACTIONABLE; C.1 CLOSED / APPROVED / PASS_TOOLING; C.1-R3 CLOSED / APPROVED / PASS_JQ_PREFLIGHT_FIX; C.2-P0 CLOSED / APPROVED / PASS_READINESS; C.2 IN PROGRESS; C.2-A IMPLEMENTED / PENDING ARCHITECTURAL REVIEW; C.2-B NOT AUTHORIZED) |
| SH-04.5 | NOT STARTED |
...
handoff actual es SH-04.4A `CLOSED / APPROVED` → SH-04.4B `CLOSED / APPROVED` → SH-04.4C.1 `CLOSED / APPROVED / PASS_TOOLING` → SH-04.4C.1-R3 `CLOSED / APPROVED / PASS_JQ_PREFLIGHT_FIX` → SH-04.4C.2-P0 `CLOSED / APPROVED / PASS_READINESS` → SH-04.4C.2-A `IMPLEMENTED / PENDING ARCHITECTURAL REVIEW`; C.2-B permanece `NOT AUTHORIZED`.
