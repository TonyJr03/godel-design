...
APPROVED / PASS_CLEAN_HOST_TARGET_BOOTSTRAP_FOUNDATION` y SH-05.2J queda
...
| SH-05.2J — Exact target generation activation | IMPLEMENTED / PENDING ARCHITECTURAL REVIEW |
...
SH-05.2J queda `IMPLEMENTED / PENDING ARCHITECTURAL REVIEW`.
